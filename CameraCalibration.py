...
class CameraCalibration():   
    ...
    def calibrateFromChessboard(self):
    ...
    def imageUndistort(self, image):
        # Read in the saved mtx and dist parameters
...
#cameraCalibration.calibrateFromChessboard()

image = mpimg.imread('camera_cal\calibration5.jpg')
dst = cameraCalibration.imageUndistort(image)
cv2.imshow('img', dst)
cv2.waitKey(5000)
